...
{
    public class RPT_0180_CONT_DSPSTNS
    {
        ...
        public string PAROLE_INDICATOR { get; set; }
        public string HOME_ARREST_INDICATOR { get; set; }
        public string ABSOLUTE_DISCHARGE_INDICATOR { get; set; }
        public string CONTINUED_UNTIL { get; set; }
